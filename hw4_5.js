class Electric {
    constructor(section){
        this.section = section || 'Электропиборы'
        this.switch = true
    }
...
const lamp = new Lamps("Лампа", "BULB")
const comp1 = new Computers("MSI", 'Laptop', 'Computers')
const comp2 = new Computers("MAC", 'PC', 'Computers')
